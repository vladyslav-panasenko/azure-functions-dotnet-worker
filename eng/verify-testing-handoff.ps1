...
$projects = @(
    ...
    (Join-Path $root 'extensions\Worker.Extensions.ServiceBus.Testing\src\Worker.Extensions.ServiceBus.Testing.csproj'),
    (Join-Path $root 'extensions\Worker.Extensions.Storage.Blobs.Testing\src\Worker.Extensions.Storage.Blobs.Testing.csproj')
)
...
foreach ($packageId in @(
    ...
    'Microsoft.Azure.Functions.Worker.Extensions.ServiceBus.Testing',
    'Microsoft.Azure.Functions.Worker.Extensions.Storage.Blobs.Testing')) {
